...
import dev.cirtellock.applock.data.repository.AppLockRepository.Companion.shouldStartService
import dev.cirtellock.applock.data.repository.BackendImplementation
import dev.cirtellock.applock.features.lockscreen.ui.PasswordOverlayActivity
...
class UsageLockService: Service() {
    ...
    private fun startForegroundService() {
        val channelId = "usage_lock_service_channel"
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelName = getString(R.string.app_protection_service_channel_name)
        ...
        val notification = NotificationCompat.Builder(this, channelId)
            ...
            .setContentText(getString(R.string.app_protection_service_running))
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                startForeground(1, notification, determineForegroundServiceType())
            } else {
