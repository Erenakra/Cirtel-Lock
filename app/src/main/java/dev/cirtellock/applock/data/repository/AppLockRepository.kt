package dev.cirtellock.applock.data.repository

import android.content.Context
import dev.cirtellock.applock.data.manager.BackendServiceManager
 ...
 * Provides a unified interface for all cirtel lock functionality.
 */
